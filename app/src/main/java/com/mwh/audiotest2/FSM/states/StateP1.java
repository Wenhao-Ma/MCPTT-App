...
public class StateP1 extends State {
    ...
    {
        Log.e("state",fsm.getName()+" Enter StateP1");
    }

    @Override
    public void leaveEvent()
    {
        Log.e("state",fsm.getName()+" Leave StateP1");
    }
    ...
    public void receiveEvent(byte[] buf, int len)
    {
        ...
        /**
         ...
         if (buf[0] == Message.PRIVATE_CALL_SETUP_REQUEST) {
         //TODO
